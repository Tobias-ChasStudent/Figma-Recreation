...
export default function ProductInfo({ itemAmount, increment, decrement }) {
    ...
    return (
        <div className="productInfo">
            ...
            <div className="price">
                <h2 className="productPrice">$125.00 <span className="discount">50%</span></h2>
                <h3 className="grey strikethrough">$250.00</h3>
            </div>
            <div className="addProduct">
                ...
                <button className="addToCart" onClick={increment}>
